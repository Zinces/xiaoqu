...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <notempty name="list">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?><div class="row noticeList">
            <a href="notice-detail.html">
               <!-- <div class="col-xs-2">
                ...
                <div class="col-xs-10">
                    ...
                    <p class="info">浏览: 199 <span class="pull-right"><?php echo (date("Y-m-d H:i:s",$channel["create_time"])); ?></span> </p>
                </div>
            </a>
