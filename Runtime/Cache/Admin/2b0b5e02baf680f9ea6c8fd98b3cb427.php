...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="price" value="<?php echo ((isset($info["price"]) && ($info["price"] !== ""))?($info["price"]):''); ?>">单位：
					<select name="company" value="<?php echo ((isset($info["company"]) && ($info["company"] !== ""))?($info["company"]):''); ?>">
						<option value="1" <?php if($info["company"] == 1): ?>selected<?php endif; ?>>元/月</option>
						<option value="2" <?php if($info["company"] == 2): ?>selected<?php endif; ?>>万元</option>
					</select>
			</div>
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="title2" value="<?php echo ((isset($info["title2"]) && ($info["title2"] !== ""))?($info["title2"]):''); ?>">
			</div>
		</div>

		<div class="form-item">
			<label>截止时间：</label>
			<input type="text" id="time-start" name="end_time" class="text input-2x" value="<?php echo ((isset($info["end_time"]) && ($info["end_time"] !== ""))?($info["end_time"]):''); ?>"/>
		</div>
